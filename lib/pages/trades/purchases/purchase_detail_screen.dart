...
import 'package:markopi/helpers/converter.dart';
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            CustomWidget.emptyVSpace(10.0),
            Text("Belum ada alamat",style: Style16Grey,),
            ...
            Align(
              ...
              child: Container(
                ...
                child: MolButton(context).blueButton(
                  onPressed: ()=>Navigator.pushNamed(context, AppRoute.PURCHASE_ADDRESS_LIST_ROUTE,arguments: {"hasAddress":false,"hasTwoAddress":false}),
                  child: Text("Pilih alamat lain",style: Style14WhiteBold,)
                ),
              ),
            ),
          ],
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text("Kopi Robusta",style: Style14BlackBold,),
                    Text("1 barang (10kg)",style: Style14Grey,),
                    CustomWidget.emptyVSpace(10.0),
                    Text("Rp.850.000" ,style: Style18Blue,)
                  ],
                )
              ],
            ),
            ...
            Row(
              ...
              children: <Widget>[
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text("Regular (2-4 hari)",style: Style14BlackBold,),
                    CustomWidget.emptyVSpace(10.0),
                    Text("JNE",style: Style14BlackBold,),
                    CustomWidget.emptyVSpace(10.0),
                    Text("Rp. 30.000",style: Style14Black,)
                  ],
                ),
                Container(
                  height: 35,
                  child: MolButton(context).blueButton(
                      onPressed: ()=>Navigator.pushNamed(context, AppRoute.PURCHASE_COURIER_ROUTE),
                      child: Text("Ubah Pengiriman",style: Style14WhiteBold,)),
                )
              ],
            )
        ...
        child: Row(
          ...
          children: <Widget>[
            Container(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(Converter().priceFormat(880000),style: Style14Blue,),
            ...
            Container(
              height: 40,
              child: MolButton(context).blueButton(
                  onPressed: ()=>widget.hasAddress? Navigator.pushNamed(context, AppRoute.PURCHASE_PAYMENT_ROUTE):null,
                  child: Text("Pilih pembayaran",style: Style14WhiteBold,)),
            )
          ],
        ),
      ),
